...
library(xtable)
filelist=c("test1.fastq","test2.fastq");
labellist=c("L1","CTRL");
reads=c(2500,2500);
mappedreads=c(1453,1471);
totalsgrnas=c(2550,2550);
zerocounts=c(1276,1199);
giniindex=c(0.5266899931488773,0.4930917310247763);
...
genboxplot("demo.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genhistplot("demo.count_normalized.txt");
@
...
genpcaplot("demo.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.5,height=4.5>>=
genclustering("demo.count_normalized.txt");
@
